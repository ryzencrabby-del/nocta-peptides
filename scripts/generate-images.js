...
const PRODUCTS = [
  { id: 'glp3-rt',           name: 'GLP-3 RT' },
  { id: 'bpc-157',           name: 'BPC-157' },
  { id: 'tb-500',            name: 'TB-500' },
  { id: 'ghk-cu',            name: 'GHK-Cu' },
  { id: 'cjc1295-ipamorelin',name: 'CJC-1295 / Ipamorelin' },
  ...
  { id: 'igf1-lr3',          name: 'IGF-1 LR3' },
  { id: 'epithalon',         name: 'Epithalon' },
  { id: '5-amino-1mq',       name: '5-Amino-1MQ' },
  { id: 'thymosin-alpha1',   name: 'Thymosin Alpha-1' },
  { id: 'semax',             name: 'Semax' },
  ...
  { id: 'wolverine-blend',   name: 'Wolverine Blend' },
